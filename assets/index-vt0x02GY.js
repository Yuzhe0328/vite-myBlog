...
import { _ as _export_sfc } from "./index-L__Od_VG.js";
import "./locales-BFy5bjh_.js";
const _hoisted_1$4 = {
  class: "line",
  style: { "margin-top": "11rem" }
};
const _hoisted_2$3 = { class: "line" };
const _hoisted_3$2 = {
  key: 0,
  class: "buttons"
};
const _hoisted_4$2 = { class: "lines" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", null, [
        createBaseVNode("div", _hoisted_1$4, toDisplayString(contentA.value), 1),
        createBaseVNode("div", _hoisted_2$3, toDisplayString(contentB.value), 1),
        showButtons.value ? (openBlock(), createElementBlock("div", _hoisted_3$2, [
          createBaseVNode("div", _hoisted_4$2, toDisplayString(currentContentC.value), 1),
...
const masterTop = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-a0f7c78a"]]);
...
const _hoisted_1$3 = ["d", "stroke", "mask"];
const _hoisted_2$2 = ["cx", "cy", "r", "fill"];
const _hoisted_3$1 = ["x", "y"];
const _hoisted_4$1 = ["id"];
const _hoisted_5$1 = ["d"];
const _hoisted_6 = ["cx", "cy", "r"];
const _hoisted_7 = ["id", "cx", "cy", "r"];
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("g", null, [
        ...
        props.dotColor ? (openBlock(), createElementBlock("circle", {
          ...
          class: "circle-dot",
          style: normalizeStyle(`--dot-color: ${props.dotColor}`),
          key: "circle-dot"
        ...
        }, toDisplayString(props.label), 11, _hoisted_3$1)) : createCommentVNode("", true),
...
const SvgNode = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-69dc75f5"]]);
const _hoisted_1$2 = {
      ...
      return openBlock(), createElementBlock("svg", _hoisted_1$2, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(__props.inputLines, (inputLine) => {
          return openBlock(), createElementBlock("g", {
            ...
            createVNode(SvgNode, mergeProps({ ref_for: true }, inputLine.value), null, 16)
          ]);
        }), 128)),
...
const SvgInputs = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-9832e4b4"]]);
const _hoisted_1$1 = ["height"];
...
const SvgOutputs = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-e06aa744"]]);
const logo = "/vite-myBlog/assets/logo-DTDX0-Gp.png";
var ScrollTrigger$1 = { exports: {} };
var ScrollTrigger = ScrollTrigger$1.exports;
var hasRequiredScrollTrigger;
function requireScrollTrigger() {
  if (hasRequiredScrollTrigger) return ScrollTrigger$1.exports;
  hasRequiredScrollTrigger = 1;
  (function(module, exports) {
    (function(global, factory) {
      factory(exports);
    })(ScrollTrigger, function(exports2) {
      ...
      */
      var gsap$1, _coreInitted$1, _win$12, _doc$12, _docEl$1, _body$1, _root$1, _resizeDelay, _toArray, _clamp$1, _time2, _syncInterval, _refreshing, _pointerIsDown, _transformProp2, _i, _prevWidth, _prevHeight, _autoRefresh, _sort, _suppressOverwrites2, _ignoreResize, _normalizer$1, _ignoreMobileResize, _baseScreenHeight, _baseScreenWidth, _fixIOSBug, _context$1, _scrollRestoration, _div100vh, _100vh, _isReverted, _clampingMax, _limitCallbacks, _startup$1 = 1, _getTime$1 = Date.now, _time1 = _getTime$1(), _lastScrollTime = 0, _enabled = 0, _parseClamp = function _parseClamp2(value, type, self) {
        ...
        var e = _doc$12.createElement("div"), useFixedPosition = _isViewport$1(container) || _getProxyProp(container, "pinType") === "fixed", isScroller = type.indexOf("scroller") !== -1, parent = useFixedPosition ? _body$1 : container, isStart = type.indexOf("start") !== -1, color = isStart ? startColor : endColor, css = "border-color:" + color + ";font-size:" + fontSize + ";color:" + color + ";font-weight:" + fontWeight + ";pointer-events:none;white-space:nowrap;font-family:sans-serif,Arial;z-index:1000;padding:4px 8px;border-width:0;border-style:solid;";
      ...
      var _clampScrollAndGetDurationMultiplier = function _clampScrollAndGetDurationMultiplier2(scrollFunc, current, end, max) {
        ...
        var _vars2 = vars, normalizeScrollX = _vars2.normalizeScrollX, momentum = _vars2.momentum, allowNestedScroll = _vars2.allowNestedScroll, onRelease = _vars2.onRelease, self, maxY, target = _getTarget(vars.target) || _docEl$1, smoother = gsap$1.core.globals().ScrollSmoother, smootherInstance = smoother && smoother.get(), content = _fixIOSBug && (vars.content && _getTarget(vars.content) || smootherInstance && vars.content !== false && !smootherInstance.smooth() && smootherInstance.content()), scrollFuncY = _getScrollFunc(target, _vertical), scrollFuncX = _getScrollFunc(target, _horizontal), scale = 1, initialScale = (Observer.isTouch && _win$12.visualViewport ? _win$12.visualViewport.scale * _win$12.visualViewport.width : _win$12.outerWidth) / _win$12.innerWidth, wheelRefresh = 0, resolveMomentumDuration = _isFunction3(momentum) ? function() {
        ...
        vars.onPress = function() {
          skipTouchMove = false;
          var prevScale = scale;
          scale = _round3((_win$12.visualViewport && _win$12.visualViewport.scale || 1) / initialScale);
          tween.pause();
  ...
  })(ScrollTrigger$1, ScrollTrigger$1.exports);
  return ScrollTrigger$1.exports;
}
var ScrollTriggerExports = /* @__PURE__ */ requireScrollTrigger();
const _hoisted_1 = { class: "main-container" };
const _hoisted_2 = { class: "masterMain" };
const _hoisted_3 = { class: "chip" };
const _hoisted_4 = { class: "chip__background" };
      ...
      scrollTriggerInstance = ScrollTriggerExports.ScrollTrigger.create({
        ...
        onEnter: () => {
          timeline2 = gsapWithCSS.timeline({
            onComplete: () => {
              var _a;
              (_a = document.querySelector(".chip__background")) == null ? void 0 : _a.classList.add("layered");
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4bfc6192"]]);
export {
  index as default
};
