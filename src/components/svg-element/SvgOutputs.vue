...
<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="700" :height="dynamicHeight" viewBox="0 0 844 40" fill="none" class="output-line"
    style="opacity: 0.8">
    ...
    <g v-for="outputLine in outputLines">
      <SvgNode path="M843.463 1.3315L245.316 5.47507L0.633077 4.69725" :position="outputLine.value.position"
        ...
        :label="outputLine.value.label" dot-color="#d499ff" glow-color="#BD34FE" />
    </g>
    <defs>
